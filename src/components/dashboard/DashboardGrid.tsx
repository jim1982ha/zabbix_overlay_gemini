              ...
              {editingWidgetId === w.id ? (
                ...
                <div className="flex-1 flex flex-col items-center justify-center min-h-[100px] h-full w-full bg-slate-50/10 dark:bg-slate-900/10">
                  <div className="flex gap-2.5">
                    <div className="w-3 h-3 rounded-full dot-loading shadow-sm" style={{ animationDelay: '-0.6s' }}></div>
                    <div className="w-3 h-3 rounded-full dot-loading shadow-sm" style={{ animationDelay: '-0.3s' }}></div>
                    <div className="w-3 h-3 rounded-full dot-loading shadow-sm" style={{ animationDelay: '0s' }}></div>
                  </div>
                </div>
              ) : (
